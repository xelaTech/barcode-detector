 ...
 *
 */
public class PDPageBarcodeScannerInit
{
  ...
  public PDPageBarcodeScannerInit(PDPage pdPage, int pageNumber, int maximumBlankPixelDelimiterCount)
  {
    this.pdPage = pdPage;
      ...
      if(xobject instanceof PDImageXObject)
      {
        ...
        if(suffix != null)
        {
          ...
          try
          {
            ...
            // new File(PdPageBarcodeScanner.WS_PATH + "/test_4_p_" + this.pageNumber + "." + "png"));
          }
          catch(Exception e)
          {
            e.printStackTrace();
  ...
  public void displayResults()
  {
    ...
    {
      System.out.println(
          "page=" + pageNumber + ", barcodeFormat=" + result.getBarcodeFormat() + ", value=" + result.getText());
    }
  }
   ...
   *          define the same area until number of blank pixel
   *          is not greater than maximumBlankPixelDelimiterCount
   * @return
   * @throws IOException
   */
  public static List<Rectangle> getAllAreaByColor(BufferedImage in, BufferedImage out, /*
                                                                                        * if not null draw rectangle for
                                                                                        * debug purpose
                                                                                        */
      int redColor, int greenColor, int blueColor, int maximumBlankPixelDelimiterCount, boolean debug)
      throws IOException
  {
    int w = in.getWidth();
    int h = in.getHeight();
  ...
  public static List<Rectangle> getAreaList(BufferedImage image, int maximumBlankPixelDelimiterCount) throws IOException
  {
    // BufferedImage out = copy(image, BufferedImage.TYPE_INT_ARGB);
    List<Rectangle> areaList = getAllAreaByColor(image, null, // only for debug use 'out' image,
        0, 0, 0, maximumBlankPixelDelimiterCount, false);

    return areaList;
  }


  public void extractBarcodeArrayByAreas(BufferedImage image, int maximumBlankPixelDelimiterCount) throws IOException
  {
  ...
  public static BufferedImage getBlackAndWhiteImage(BufferedImage image) throws IOException
  {
  ...
  public static BufferedImage getThresholdImage(BufferedImage image) throws IOException
  {
