...
public class ImageDisplay extends JPanel
{
  ...
  private ImageDisplay(final String image_file)
  {
    try
    {
      /**
  ...
  private ImageDisplay(final Mat openCV_img)
  {
    try
    {
      this.image = ImageDisplay.getBufImg(openCV_img);
    }
    catch(final IOException e)
    {
      // Let us know what happened
  ...
  public static void showImageFrame(final String image_file)
  {
    // convenience function that displays a frame with the image in the parameters

    ImageDisplay.displayFrame(new ImageDisplay(image_file), image_file);
  }


  public static void showImageFrame(final Mat openCV_img, final String title)
  {
    // convenience function that displays a frame with the image in the parameters
    ImageDisplay.displayFrame(new ImageDisplay(openCV_img), title);
  }


  public static ImageDisplay getImageFrame(final Mat openCV_img, final String title)
  {
    // convenience function that displays a frame with the image in the parameters
    final ImageDisplay window = new ImageDisplay(openCV_img);
  ...
  public static void showImageFrameGrid(final Mat openCV_img, final String title)
  {
    // convenience function that displays a frame with the image in the parameters
    final Mat displayImg = openCV_img.clone();
